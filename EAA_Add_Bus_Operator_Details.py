...
def add_bop():
    if True:
        Label(options, text="8 Sutlez Travels Delhi 2233445566 sutlez.trav@gmail.com").grid(row=1,column=0, columnspan=11)
...
def edit_bop():
    if True:
        Label(options, text="8 Sutlez Travels Kashmiri Gate Delhi 2233445566 sutlez.travels@gmail.com").grid(row=1,column=0, columnspan=11)
...
home=Button(options, image=hm).grid(row=1, column=8, pady=30)
