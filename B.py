...
B=Button(root,text="Seat Booking", bg="PaleGreen1" , font=("Arial Bold", 25)).grid(row=3,column=3, padx=30, pady=100)
B=Button(root,text="Check booked Seat", bg="Green2", font=("Arial Bold", 25)).grid(row=3,column=4, padx=30, pady=100)
B=Button(root,text="Add Bus Details", bg="Green", font=("Arial Bold", 25)).grid(row=3,column=5, padx=30, pady=100)
